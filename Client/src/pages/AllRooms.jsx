...
const AllRooms = () => {
    ...
    const matchesRoomType = (room) => {
        return selectedFilters.roomType.length === 0 ||
            selectedFilters.roomType.includes(room.type);
    }
    ...
    const filterDestination = (room) => {
        ...
        return room.hotel.city.toLowerCase().includes(filterDestination.toLowerCase()) 
    }
    ...
    md:px-16 lg:px-24 xl:px-32'>
      <div>
        <div className='flex flex-col items-start text-left'>
            <h1 className='font-playfair text-4xl mf:text-[40px]'>Hotel Rooms</h1> 
        ...
        overflow-hidden transition-all duration-700`}>
            ...
            <div className='px-5 pt-5'>
                ...
                {priceRanges.map((Range, index)=>(
                    <CheckBox key={index} label={`${currency} ${Range}`} selected=
