...
const RoomDetails = () => {
    ...
    // onsubmit handler function to ceck availability or book the room
    ...
    useEffect (()=>{
        const room = room.find(room => room._id === id)
        room && setRoom(room)
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        ...
        text-gray-500'>
          ...
          <div className='flex flex-col'>
            ...
            type="date" id='guests' placeholder='1' 
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to the availability. You get a comfortable
          two bedroom apartment has a true city feeling. The price quoted is for two guests, at the guest slot please
          mark the number of guest to get te exact price for groups. The Guests will be allocated ground floor
          according to availability. You get a comfortable two bedroom apartment has a true city feeling. 
        </p>
      </div>
    {/* Hosted by */}
